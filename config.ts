const siteMetadata = {
    ...
    twoColumnWall: true,
    cookiePolicy: true,
    introTag: `Wealth Management, Set Free`,
    description: `Wealthbot also known as "Webo", is the world's only open source wealth management platform for RIA's`,
    about:
